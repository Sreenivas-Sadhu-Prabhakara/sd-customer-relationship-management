package com.bank.bian.customerrelationshipmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Customer Relationship Strategy".
 *
 ...
 * to its asset type (Customer Relationship). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Relationship Strategy";
